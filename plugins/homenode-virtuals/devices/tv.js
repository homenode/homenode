module.exports = {
  ...
  homekit(accessory, HomeKit) {
    ...
    const service = accessory.addService(Service.Television, 'Fake Television', 'Television');
    ...
    const inputLiveTV = accessory.addService(Service.InputSource, 'livetv', 'Live TV');
    ...
    const inputHDMI1 = accessory.addService(Service.InputSource, 'hdmi1', 'HDMI 1');
    ...
    const inputHDMI2 = accessory.addService(Service.InputSource, 'hdmi2', 'HDMI 2');
    ...
    const inputNetflix = accessory.addService(Service.InputSource, 'netflix', 'Netflix');
    ...
    const inputSpotify = accessory.addService(Service.InputSource, 'spotify', 'Spotify');
    ...
    const inputYouTube = accessory.addService(Service.InputSource, 'youtube', 'YouTube');
    ...
    service.addLinkedService(inputLiveTV);
    service.addLinkedService(inputHDMI1);
    service.addLinkedService(inputHDMI2);
    service.addLinkedService(inputNetflix);
    service.addLinkedService(inputSpotify);
    service.addLinkedService(inputYouTube);
  },
};
